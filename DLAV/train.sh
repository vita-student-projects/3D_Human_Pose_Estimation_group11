...
python train.py --dataset_path '../data/dataset.h5' --epochs 30 --batch_size 10 --num_workers 1 --lr 0.0005 --save_interval 1 --checkpoint_dir 'checkpoints' --data_ratio 0.02 --validation_ratio 0.1 --test_ratio 0.0
