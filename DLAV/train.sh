...
python train.py --dataset_path '../data/dataset.h5' --epochs 10 --batch_size 10 --num_workers 1 --lr 0.01 --save_interval 1 --checkpoint_dir 'checkpoints' --data_ratio 0.2 --validation_ratio 0.3 --test_ratio 0.0
