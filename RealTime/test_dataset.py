...
class H36M(tData.Dataset):
    def __init__(self,h5_path,video_id=1,subject=11,patch_width=256,patch_height=256,split = 'train', image = 'test'):
    ...
    def __getitem__(self, index):
        ...
        with h5py.File(h5_path,'r') as db:
            print(idx)
            print("HERE",db['joints3d_cam'][idx].shape)
